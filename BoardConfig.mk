...
BOARD_PREBUILT_BOOTIMAGE := device/qcom/volcano/GKI/boot.img
BOOT_OS_VERSION = $(PLATFORM_VERSION_LAST_STABLE)
BOOT_SECURITY_PATCH = $(PLATFORM_SECURITY_PATCH)
BOARD_PREBUILT_SYSTEM_DLKMIMAGE := device/qcom/volcano/GKI/system_dlkm.img
endif

BOARD_RAMDISK_USE_LZ4 := true

-include $(QCPATH)/common/volcano/BoardConfigVendor.mk

SECTOOLS_SECURITY_PROFILE := $(QCPATH)/securemsm/security_profiles/volcano_tz_security_profile.xml
...
AB_OTA_UPDATER := true
TARGET_RECOVERY_FSTAB := device/qcom/volcano/recovery.fstab
else
TARGET_RECOVERY_FSTAB := device/qcom/volcano/recovery_non_AB.fstab
...
ifeq ($(IS_IOT_TARGET), true)
    BOARD_DTBOIMG_PARTITION_SIZE := 0x8000000
else
    BOARD_DTBOIMG_PARTITION_SIZE := 0x2100000
endif
...
include device/qcom/wlan/volcano/BoardConfigWlan.mk
endif
else
include device/qcom/wlan/volcano/BoardConfigWlan.mk
endif
