...
PRODUCT_BRAND := qti
PRODUCT_MODEL := volcano for arm64
#----------------------------------------------------------------------
# wlan specific
#----------------------------------------------------------------------
ifeq ($(TARGET_USES_QMAA), true)
...
#tp firmware
PRODUCT_COPY_FILES += \
    device/qcom/volcano/fps/tpfirmware/EPH86XX_fw_v2437.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/EPH86XX_fw.bin\
# ODM ueventd.rc
...
LOCAL_CAMX_OVERRIDE_SETTINGS_DEST := $(TARGET_COPY_OUT_VENDOR)/etc/camera/camxoverridesettings.txt
